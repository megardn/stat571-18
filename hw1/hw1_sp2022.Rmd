...
Dropping any respondents who are missing answers for listening to Sirius Radio or Wharton radio, since this data won't be usable for our analyses. Further, any subjects who reported listening to the Wharton radio show but not to Sirius Radio were excluded on the basis of input error.
...
Data summary for each variable, including number of missing responses, displayed below:
...
d<- ggplot(radio) + 
  ...
  ggtitle("Reported education of survey respondents") #should i drop NA before plotting?
d
```

Reported household income was plotted among those who do and do not listen to Wharton's radio show.

``` {r income.plot}
i<- ggplot(radio, aes(x=income, fill=wharton)) + 
  geom_bar(stat="count") +
