...
```
In order to make this comparison, I will compare the regression I ran to test the change in log pay's predictive ability, with one testing the predictive ability of payroll as such. The criteria I will use is the effect size (R^2) and statistical significance (p-value) of the regression of each independent variable (payroll vs change in log payroll) on change in win percentage. 
