...
```{r}
# to answer these questions, let's create a new data.frame that contains each team, their corresponding log chang ein payroll between 2010 and 2014, and their corresponding change in win percentage between those same years
