...
As we can see, under the assumption that a_10/a_01, the threshold given to us by Bayes rule does very well in finding the optimal threshold (0.0909) to minimize MCE.  
...
As we can see, Bayes rule does well at finding the threshold (0.5 in this case) at which the MCE is minimized, given the appropriate risk ratio. This is illustrated by the new threshold given the 1/1 ratio. 
