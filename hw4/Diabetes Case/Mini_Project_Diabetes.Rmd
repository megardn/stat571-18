...
Now we'll compare the bestglm and LASSO models' on AUC/ROC; Anova to see which one is best for prediction. *add chi sq and Anova*
...
# #chi-square - can't compare directly with anova because of different sizes, not sure what to do here
# anova(fit.glm.final, fit.logit.1)
```

The ROC curve and AUC clearly indicate that our final LASSO model is superior to the bestglm model across thresholds. We'll next compare prediction using starting we'll threshold our probability of readmission at 1/2. 
