...
fit.glm.1$BestModels
fit.glm.1$BestModel

# check significance of predictors in BestModel
# summary(glm(readmit_30~race+age_mod, family=binomial, data=data.train.m))
```

Interestigly, race is not significant so we can 
