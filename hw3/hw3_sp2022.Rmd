...
Logically, GPM may be better because it more directly reflects fuel consumption. Additionally, when calculating fuel use over a fixed distance,
...
Data-Driven Interaciton Testing:
...
As seen above, both models have nearly identical explanatory power ($\sigma$ and Adjusted $R^2$); therefore we will chose the more parsimonious model without interaction effects for ease of interpretation. However, it is interesting to consider how acceleration grows (cars take longer to accelerate from 0 to 60 mph) the effect of horsepower on gpm increases; *why would this be happening?*
