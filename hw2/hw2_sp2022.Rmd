...
pacman::p_load(ISLR, tidyverse, data.table, reshape2) # add the packages needed
```
...
```
As we can see, while the degree to which items are correlated varies, there are no negative correlations, indicating that the items in this questionnaire are correlated to each other. 
