...
if(!require('pacman', 'factoextra', 'AMR')) {install.packages('pacman', 'factoextra', 'AMR')}
#if(!require('reshape2')) {install.packages('reshape2')} # this will be useful later for plotting
pacman::p_load(ISLR, tidyverse, data.table, reshape2, AMR, factoextra) # add the packages needed
```
